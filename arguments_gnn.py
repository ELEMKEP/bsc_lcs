...
def _add_graph_arguments(parser):
    ...
    parser.add_argument('--pre-graph-path', type=str, default='graphs',
                        help='Directory path of graph files.')
    parser.add_argument('--pre-graph-prefix', type=str, default='graph',
                        help='Prefix of graph file name.')
    parser.add_argument(
        '--pre-graph-type', type=str, default='dist', help=
        'Predefined graph structure (dist, corr, rand) - (mi, msc) are not implemented'
    )
    parser.add_argument('--pre-graph-k', type=int, default=4,
                        help='Connecitivty (edge size) of predefined graph')
    parser.add_argument('--pre-graph-binarized', action='store_true',
                        default=False,
                        help='Use binarized graph rather than real graph.')
    parser.add_argument(
        '--pre-graph-expand', action='store_true', default=False,
        help='Use expanded 8-band graph for stgcn, rgnn, and dgcnn')
    parser.add_argument(

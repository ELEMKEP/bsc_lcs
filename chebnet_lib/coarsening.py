...
def metis(W, levels, rid=None):
    ...
    for idx_level in range(levels):
        ...
        #         print((idx_row.shape, idx_col.shape, val.shape))
...
assert (compute_perm(
    [np.array([4, 1, 1, 2, 2, 3, 0, 0, 3]),
     np.array([2, 1, 0, 1, 0])]) == [[3, 4, 0, 9, 1, 2, 5, 8, 6, 7, 10, 11],
                                     [2, 4, 1, 3, 0, 5], [0, 1, 2]])
